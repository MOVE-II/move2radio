function(MOVEII_BUILD_CMAKE name)
  ...
  ADD_CUSTOM_COMMAND(OUTPUT ${BUILD_PATH}/${name}/Makefile
	COMMAND env PKG_CONFIG_PATH=${PREFIX_PATH}/usr/lib/pkgconfig ${CMAKE_COMMAND} -DCMAKE_BUILD_TYPE=Release -DCMAKE_FIND_ROOT_PATH=${PREFIX_PATH} -DCMAKE_INSTALL_PREFIX=${PREFIX_PATH}/usr ${BUILD_EXTRA_OPTIONS} ${${prefix}_SOURCE}${BUILD_SOURCE_SUFFIX}
	DEPENDS ${name}
